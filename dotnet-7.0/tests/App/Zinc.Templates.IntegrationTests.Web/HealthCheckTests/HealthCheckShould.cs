...
namespace Zinc.Templates.IntegrationTests.Web.HealthCheckTests
{
    public class HealthCheckShould : WebTestBase
    {
        public HealthCheckShould(WebTestFixture fixture, ITestOutputHelper output)
            : base(fixture, output)
        {
        }
