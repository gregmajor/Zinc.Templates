...
{
    [Collection(nameof(MessagingTestCollection))]
    public abstract class MessagingTestBase : IAsyncLifetime
    {
        protected MessagingTestBase(MessagingTestFixture fixture, ITestOutputHelper output)
        {
        ...
        /// </summary>
        protected MessagingTestFixture Fixture { get; }
